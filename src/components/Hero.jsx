...
function Hero() {
  ...
  return (
    <section className="min-h-screen bg-[#0a0a1a] flex items-center justify-center pt-16 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-2 gap-16 items-center z-10">
        <div>
          ...
          <div className="text-2xl text-[#d4af37] mb-6 h-8 font-medium">
        ...
        <div className="flex justify-center">
          <div className="relative">
            ...
            <div className="w-80 h-80 rounded-full border-4 border-[#d4af37] overflow-hidden shadow-2xl relative">
              <img src={profileImg} alt="Abdul Hannan" className="w-full h-full object-cover object-top" />
            </div>
            <div className="absolute -bottom-4 -right-4 bg-[#d4af37] text-[#0a0a1a] px-4 py-2 rounded-full text-sm font-bold shadow-lg">
              Open to Work ✓
            </div>
            ...
            <div className="absolute top-1/2 -right-16 bg-gray-900 border border-gray-700 text-white px-3 py-2 rounded-xl text-xs">
              <div className="text-[#d4af37] font-bold">1</div>
              <div className="text-gray-400">Live App</div>
            </div>
          </div>
        </div>
      </div>
